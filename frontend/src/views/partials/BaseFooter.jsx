        ...
        <div className="row">
          <div className="col-lg-4 col-md-6 col-12 text-white">
            ...
            <div className="mb-4">
              ...
              <div className="mt-4">
                <p>
                EduFlux offers a sleek e-learning platform with feature-rich components and a stunning Bootstrap UI Kit. 
                Designed for developers, it ensures a responsive and engaging learning experience.
                </p>
                {/* social media */}
          ...
          <div className="col-lg-3 col-md-12">
            ...
            <div className="mb-4">
              ...
              <p className="mb-1">
                Email:
                <a href="#" className='text-white'> support@eduflux.com</a>
              </p>
              <p>
                Phone:
